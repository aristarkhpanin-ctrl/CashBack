...
# ---------------------------------------------------------------------------
# ML explanations (фаза 25) — список клиентов для левой панели.
# ---------------------------------------------------------------------------
class MlCustomer(BaseModel):
    customer_id: str
    name: str
    segment: str        # витринное имя корзины (или «—»)
    prediction: float   # последняя model_score из recommendations
